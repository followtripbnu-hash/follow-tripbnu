...
<head>
    ...
    <!-- Título e SEO -->
    <title>Follow Trip | Excursões Oficiais</title>
    ...
    <meta property="og:title" content="Follow Trip - Excursões">
    <meta property="og:description" content="Sua vaga para o festival começa aqui. Transporte executivo e galera animada.">
...
<body class="bg-black text-neutral-100 min-h-screen flex flex-col">
    ...
    <script type="text/babel" data-type="module">
        ...
        const productionConfig = {
            apiKey: "AIzaSyC39OUcP5pMKUUzkkaWvQEHhaQl-AH84pc",
            authDomain: "followsite-5e0ba.firebaseapp.com",
            projectId: "followsite-5e0ba",
            storageBucket: "followsite-5e0ba.firebasestorage.app",
            messagingSenderId: "171432925082",
            appId: "1:171432925082:web:1ccb4a01b9851c5afd8c23",
            measurementId: "G-K0VPC2XLMS"
        };
        ...
        try {
            if (Object.keys(firebaseConfig).length > 0 && firebaseConfig.apiKey !== "COLE_SUA_API_KEY_AQUI") {
                ...
                console.warn("⚠️ Firebase não configurado. O app funcionará apenas visualmente (sem salvar dados).");
            }
            ...
            return (
                <div className="font-sans text-neutral-100 flex-grow flex flex-col min-h-screen">
                    ...
                    <main className="max-w-6xl mx-auto p-4 md:p-8 flex-grow w-full relative z-0">
                        ...
                        {!loading && view === 'login-admin' && <LoginScreen title="ACESSO ADMIN" hint="Gestão da plataforma." onLogin={handleAdminLogin} icon={<Shield className="h-10 w-10 text-red-600 mb-4" />} />}
                    ...
                    <footer className="border-t border-white/5 bg-black/60 backdrop-blur-xl py-10 mt-auto">
                        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
                            <div className="text-center md:text-left">
                                <p className="text-neutral-600 text-[10px] font-black uppercase tracking-[3px]">© 2024 Follow Trip • Santa Catarina</p>
            ...
            return (
                <div className="max-w-md mx-auto mt-20 glass-panel p-10 rounded-3xl shadow-2xl animate-enter relative overflow-hidden">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <h2 className="text-2xl font-black text-white uppercase">Área do Motorista</h2>
                ...
                <div className="animate-enter">
                    <div className="text-center mb-20 py-20 glass-panel rounded-[3rem] relative overflow-hidden">
                        ...
                        <div className="relative z-10 px-6">
                            <span className="inline-block py-1.5 px-4 rounded-full bg-white/5 border border-white/10 text-[10px] font-black uppercase tracking-[0.2em] text-neutral-400 mb-8 backdrop-blur-md">Próximas Saídas</span>
                            ...
                            <p className="text-neutral-400 text-lg md:text-xl max-w-2xl mx-auto font-medium leading-relaxed">
                                Transporte oficial para os maiores festivais. Segurança, conforto e aquela resenha que só a gente tem.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
                        ...
                        <FeatureCard icon={<Star className="text-yellow-500 h-6 w-6"/>} title="Conforto Total" desc="Ônibus executivos e semi-leito com ar e poltronas reclináveis." />
                        <FeatureCard icon={<Music className="text-purple-500 h-6 w-6"/>} title="Vibe Garantida" desc="A festa começa no embarque. Conheça sua galera." />
                    </div>
                                ...
                                <div className="p-8 flex flex-col flex-grow">
                                    ...
                                    <div className="space-y-4 mb-8">
                                        <div className="flex justify-between items-center border-b border-white/5 pb-2">
                                            <span className="text-neutral-500 text-[10px] font-black uppercase tracking-widest">Saída</span>
                                            <span className="text-white font-bold text-sm">{masks.date(event.departureDate)} • {event.departureTime}h</span>
                                        </div>
                                        <div className="flex justify-between items-center border-b border-white/5 pb-2">
        ...
        // --- FLUXO DE RESERVA (COM CONTRATO JURÍDICO COMPLETO) ---
        ...
        function BookingWizard({ event, appId, db, user, onBack, notify }) {
            ...
            const handleNext = async () => {
                ...
                setLoading(false);
                if (isDup) return notify("CPF já cadastrado nesta trip.", "error");
                setStep(2);
            };

            const handleConfirm = async () => {
                if (!user) return notify("Erro de conexão.", "error");
                setLoading(true);
                try {
            ...
            const contractTxt = `
CONTRATO DE PRESTAÇÃO DE SERVIÇOS POR CONTRATANTE (PASSAGEIRO):
...
2. DO OBJETO
2.1. O presente contrato tem como objeto a prestação de serviço de transporte FRETADO/INDIVIDUAL para participação em festival/evento musical, organizado por terceiros, com saída da(s) cidade(s) previamente informada(s) pela CONTRATANTE e destino ao local do evento pela contratada.

Parágrafo único: O(a) CONTRATADA não é responsável pela organização, produção ou realização do evento, limitando-se exclusivamente ao serviço de transporte fretado.
...
Data de saída: ${masks.date(event.departureDate)}
Horário previsto: ${event.departureTime}h
Local(is) de embarque: Verificar nos grupos oficiais
Data de retorno: ${masks.date(event.returnDate)} (após o encerramento do evento)
...
6.1. A CONTRATANTE compromete-se a realizar o transporte com segurança, obedecendo às normas de trânsito e manutenção veicular.
...
8.2. Ao efetuar o pagamento, o PASSAGEIRO declara que leu, compreendeu e concorda integralmente com Todos os termos deste contrato.
                    ...
                    <div className="p-8 md:p-12">
                        ...
                        {step === 1 && (
                            <div className="space-y-6 animate-enter">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    ...
                                    <InputDark label="Órgão Emissor" value={formData.issuer} onChange={e => setFormData({...formData, issuer: e.target.value})} />
                        ...
                        {step === 2 && (
                            <div className="space-y-6 animate-enter">
                                ...
                                <label className="flex items-center gap-4 p-4 border border-neutral-700 rounded-xl cursor-pointer hover:bg-white/5 transition select-none">
                                    ...
                                    <span className="text-sm font-medium text-neutral-300">Li e concordo com os termos de serviço.</span>
                                </label>
                        ...
                        {step === 3 && (
                            <div className="text-center py-10 animate-enter">
                                ...
                                <p className="text-neutral-400 mb-8 max-w-sm mx-auto font-medium">Sua pré-reserva foi feita. Para garantir seu lugar, realize o pagamento via PIX agora mesmo.</p>
        ...
        function AdminDashboard({ events, appId, db, user, notify, currentPassword }) {
            ...
            // Função para manipular o upload de arquivo sem limite de tamanho
            ...
            const handleSave = async () => {
                if(!newEvent.title) return notify("Título obrigatório", "error");
                try {
                    if (editingId) {
            ...
            const handleChangePassword = async () => {
                ...
                if (passForm.next !== passForm.confirm) return notify("As senhas não coincidem.", "error");
                ...
                <div className="grid md:grid-cols-4 gap-8">
                    <div className="glass-panel p-6 rounded-3xl h-fit">
                        ...
                        <nav className="space-y-2">
                            ...
                            <button onClick={() => {setTab('settings'); setSelectedId(null)}} className={`w-full text-left p-3 rounded-xl font-bold uppercase text-xs tracking-widest transition-all ${tab==='settings' ? 'bg-red-600 text-white' : 'text-neutral-500 hover:text-white hover:bg-white/5'}`}>Configurações</button>
                        </nav>
                    </div>
                    <div className="md:col-span-3 glass-panel p-8 rounded-3xl min-h-[500px]">
                        {tab === 'create' && (
                            <div className="space-y-6 animate-enter">
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    ...
                                    <AdminInput label="Preço (R$)" type="number" value={newEvent.price} onChange={e => setNewEvent({...newEvent, price: e.target.value})}/>
                                ...
                                <button onClick={handleSave} className="bg-white text-black px-8 py-4 rounded-xl font-black uppercase tracking-widest text-xs hover:bg-neutral-200 mt-4 w-full md:w-auto">{editingId ? 'Salvar Alterações' : 'Publicar Viagem'}</button>
                            </div>
                        )}
                                    ...
                                    <div key={e.id} className="bg-neutral-900/50 p-6 rounded-2xl flex flex-col md:flex-row justify-between items-center border border-white/5 hover:border-white/10 gap-4">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-neutral-500 text-xs font-bold uppercase tracking-widest flex items-center gap-2"><Calendar size={12}/> {masks.date(e.departureDate)} • {e.eventCity}</p>
                                            </div>
                                        </div>
                        ...
                        {tab === 'settings' && (
                            <div className="animate-enter max-w-md">
                                <h2 className="text-2xl font-black text-white uppercase italic mb-6">Segurança</h2>
                                <div className="space-y-4">
                            ...
                            <div className="animate-enter">
                                ...
                                <div className="overflow-x-auto rounded-xl border border-white/5">
                                    <table className="w-full text-left text-sm">
                                        <thead className="text-neutral-500 uppercase text-[10px] tracking-widest bg-neutral-900"><tr><th className="p-4">Nome / CPF</th><th className="p-4">Status</th><th className="p-4 text-right">Ação</th></tr></thead>
...
CONTRATO DE PRESTAÇÃO DE SERVIÇOS DE TRANSPORTE FRETAMENTO INDIVIDUAL:

CONTRATANTE (ORGANIZADOR): FOLLOW TRIP representada por Izaias Galom dos Santos Junior, pessoa física, inscrito no CPF 096.668.669-19 e no RG 6.672-002 SSP/SC, residente no endereço Tusnelda Bachmann 373, no CEP 89040320 no bairro Velha Central na cidade de Blumenau SC.

CONTRATADA (EMPRESA): RAZÃO SOCIAL: ${contractData.company.toUpperCase()}, pessoa jurídica inscrita no CNPJ ${contractData.cnpj}, com empresa residente no endereço ${contractData.address}.

CLÁUSULA 1 – DO OBJETO
1.1. O presente contrato tem por objeto a prestação de serviço de transporte fretamento individual, com saída da cidade de ${contractData.city} e destino à cidade de ${event.eventCity}, a ocorrer na data ${masks.date(event.departureDate)}, com horário previsto de embarque às ${event.departureTime} horas.

CLÁUSULA 2 – DO ITINERÁRIO
Origem: ${contractData.city}
Destino: ${event.eventCity}
Detalhes da Rota: ${contractData.routeDetails}

CLÁUSULA 3 – DO VALOR E PAGAMENTO
3.1. O valor do serviço será informado previamente ao CONTRATANTE no ato da contratação.
3.2. A reserva do fretado será considerada confirmada após a compensação do pagamento de sinal acordado entre ambas as partes .

CLÁUSULA 4 – DA POLÍTICA DE CANCELAMENTO E REEMBOLSO
4.1. Em caso de impossibilidade de realização da viagem por parte da CONTRATADA, esta deverá ressarcir integralmente os valores pagos ou providenciar, sob sua responsabilidade e custo, outra empresa de mesma categoria para realizar o serviço.
4.2. O reembolso integral somente será possível até 05 (cinco) dias corridos após a data do pagamento TOTAL da viagem.
4.3. Após o prazo de 05 (cinco) dias e até o limite de 07 (sete) dias corridos da data do pagamento TOTAL, o CONTRATANTE terá direito a reembolso parcial correspondente a 70% (setenta por cento) do valor pago.
4.4. Após o prazo de 07 (sete) dias corridos da data do pagamento TOTAL, não haverá qualquer reembolso, sendo o valor integralmente retido.
4.6. Em caso de cancelamento definitivo do evento (e não adiamento) por motivos de força maior, será avaliada a possibilidade de reembolso conforme as condições operacionais da CONTRATADA.

CLÁUSULA 5 – DAS RESPONSABILIDADES
5.1. A CONTRATADA compromete-se a realizar o transporte com segurança, respeitando as normas de trânsito e mantendo o veículo em condições adequadas de uso.
5.2. O CONTRATANTE é responsável por comparecer no local e horário informados, portando documento oficial com foto.
5.3. A CONTRATADA não se responsabiliza por objetos pessoais esquecidos ou extraviados no interior do veículo.

CLÁUSULA 6 – DA TOLERÂNCIA PARA EMBARQUE (IDA)
6.1. Será concedida tolerância máxima de 10 (dez) minutos após o horário previsto para embarque.
6.2. Após esse período, o transporte seguirá viagem sem qualquer obrigação de aguardar ou reembolsar o passageiro ausente.

CLÁUSULA 7 – DA TOLERÂNCIA PARA EMBARQUE (RETORNO)
7.1. Será concedida tolerância máxima de 60 (sessenta) minutos após o horário oficial de encerramento do evento.
7.2. É de total responsabilidade do CONTRATANTE localizar o ônibus e/ou o guia da excursão para realizar o embarque de retorno.
7.3. Após o período de tolerância, o transporte seguirá viagem sem qualquer obrigação de aguardar ou reembolsar o passageiro ausente.

CLAÚSULA 8 - DO PAGAMENTO
8.1. Pela prestação do serviço, o CONTRATANTE pagará à CONTRATADA a importância total de ${contractData.paymentTotal || 'R$ 0,00'}, conforme cronograma acordado entre ambas as partes.
8.2. A rescisão poderá ocorrer por ambas as partes mediante aviso prévio por escrito com antecedência mínima de 15 dias.
8.3. O presente contrato tem a finalização completa do serviço de transporte ao desembarque dos passageiros conforme data de ${masks.date(contractData.contractEnd)}.

CLÁUSULA 9 – DAS DISPOSIÇÕES FINAIS
9.1. O presente contrato passa a valer a partir da confirmação do pagamento do sinal/total.
9.2. Ao contratar o serviço, o CONTRATANTE declara ter lido, compreendido e aceito integralmente todos os termos deste contrato.
...
Assinado digitalmente por ${contractData.company} e Follow Trip.
                    ...
                    <div className="glass-panel p-10 rounded-[2rem] animate-enter">
                        <div className="flex justify-between items-start mb-8 border-b border-white/5 pb-6">
                            <div>
                                ...
                                <p className="text-neutral-500 font-bold uppercase tracking-widest text-xs mt-1">{event.title} • {masks.date(event.departureDate)}</p>
                            </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="bg-neutral-900/50 p-8 rounded-3xl border border-white/5 text-center flex flex-col justify-center items-center">
                                ...
                                <p className="text-neutral-500 text-xs mb-6 max-w-xs">Lista completa com RG e Órgão Emissor para conferência no embarque e fiscalização.</p>
            ...
            return (
                <div className="max-w-3xl mx-auto glass-panel p-10 rounded-3xl animate-enter">
                    <h2 className="text-2xl font-black text-white uppercase italic mb-6">Contrato de Prestação de Serviço</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="md:col-span-2"><AdminInput label="Razão Social" value={contractData.company} onChange={e => setContractData({...contractData, company: e.target.value})} /></div>
                        ...
                        <div className="md:col-span-2"><AdminInput label="Endereço Completo" value={contractData.address} onChange={e => setContractData({...contractData, address: e.target.value})} /></div>
                        ...
                        <AdminInput label="Placa do Veículo" value={contractData.plate} onChange={e => setContractData({...contractData, plate: e.target.value})} />
